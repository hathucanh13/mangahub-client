...
const (
	MangaService_GetManga_FullMethodName       = "/manga.v1.MangaService/GetManga"
	MangaService_Search_FullMethodName         = "/manga.v1.MangaService/Search"
	MangaService_UpdateProgress_FullMethodName = "/manga.v1.MangaService/UpdateProgress"
)
...
type MangaServiceClient interface {
	...
	// UC-015
	Search(ctx context.Context, in *SearchMangaRequest, opts ...grpc.CallOption) (*SearchMangaResponse, error)
	// UC-016
...
func (c *mangaServiceClient) Search(ctx context.Context, in *SearchMangaRequest, opts ...grpc.CallOption) (*SearchMangaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchMangaResponse)
	err := c.cc.Invoke(ctx, MangaService_Search_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MangaServiceServer interface {
	...
	// UC-015
	Search(context.Context, *SearchMangaRequest) (*SearchMangaResponse, error)
	// UC-016
...
func (UnimplementedMangaServiceServer) Search(context.Context, *SearchMangaRequest) (*SearchMangaResponse, error) {
...
func _MangaService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MangaService_Search_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MangaServiceServer).Search(ctx, req.(*SearchMangaRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MangaService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "manga.v1.MangaService",
